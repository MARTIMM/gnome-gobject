...
note "type class: $!class-gtype, $!class-name";
  ...
  if $!n-native-object ~~ N-GObject and
    ...
    note "\nObject gtype: $!class-gtype" if $Gnome::N::x-debug;
  ...
  test-call( $s, $!n-native-object, |@params, |%named-params)
}
#}}
...
method get-native-object ( --> Any ) {
  ...
  #$!g-boxed
  self.native-object-ref($!g-boxed)
}
